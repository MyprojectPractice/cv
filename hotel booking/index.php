       ...
       <img class="img-responsive" src="images/home_banner.jpg" style="width:100%; height:180px;">
        ...
        <div class="row" style="color: #ffbb2b">
            <div class="col-md-4 wellfix">
              ...
              Address : K.R BANGALORE-560049..<br>
              Mail : 55ranwarpasha@gial.com.. <br>
            </div>
            <div class="col-md-4"></div>
            <div class="col-md-4 wellfix">
                <h4><strong>Developed By</strong></h4><hr>
                DEVELOPER:R ANWAR PASHA..<br>
                COLLEGE NAME:SEA COLLEGE OF ENGINEERING <br>
                        AND TECHNOLOGY....<br>
                ADDRESS:EKTANAGAR KR PURAM BANGALORE-560049.<br>
            </div>
        </div>
